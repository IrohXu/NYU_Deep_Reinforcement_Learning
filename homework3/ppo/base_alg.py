...
class BasePolicyGradient:
    ...
    def _log_summary(self):
        ...
        # Save the logging to plot cache
        self.plot_cache['timesteps'].append(t_so_far)
        self.plot_cache['loss'].append(avg_actor_loss)
        self.plot_cache['return'].append(avg_ep_rews)
